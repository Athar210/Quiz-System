...
namespace WindowsFormsApplication2
{
    public partial class setexam : Form
    {
        ...
        private void setexam_Load(object sender, EventArgs e)
        {
            ...
            this.student_recordTableAdapter.Fill(this.quizappDataSet1.student_record);
            string q = "select * from student_record";
            viewclass vc = new viewclass(q);
            dataGridView1.DataSource = vc.showrecord();
            SqlDataAdapter dadpter = new SqlDataAdapter("select distinct std_batchcode from student_record","Data Source=DESKTOP-B6M2MNK\\SQLEXPRESS;Initial Catalog=quizapp;Integrated Security=True");
